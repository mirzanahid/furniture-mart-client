...
const MyProducts = () => {
    ...
    useEffect(() => {
        axios.get(`https://furniture-mart-server-pink.vercel.app/products/${user?.email}`)
    ...
    const handlerForDeleteProduct = (id) => {
        ...
        if (sure) {
            fetch(`https://furniture-mart-server-pink.vercel.app/products/${id}`, {
                method: 'DELETE'
            })
                .then(res => res.json())
                .then(data => {
    ...
    const handleForAdvertise = (id) => {
        ...
        fetch(`https://furniture-mart-server-pink.vercel.app/advertise/${id}`, {
            method: 'PATCH',
            headers: {
